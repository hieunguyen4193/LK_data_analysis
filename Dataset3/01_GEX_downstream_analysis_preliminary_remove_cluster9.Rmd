...
# ##### REMOVE CLUSTER 9
if (PROJECT == "230215_Kopplin_Pabst_added_NC_000001_merged_zcat_m330_m331"){
...
if (file.exists(file.path(path.to.01.output, sprintf("%s.addVDJ.rds", PROJECT))) == FALSE){
  ...
  saveRDS(s.obj, file.path(path.to.01.output, sprintf("%s.addVDJ.rds", PROJECT))) 
} 
```
