...
```{r results='asis', echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=10, dev='svg'}
if (file.exists(file.path(path.to.01.output, "230215_Kopplin.seurat.obj.rds")) == FALSE){
  saveRDS(object = s.obj, file = file.path(path.to.01.output, "230215_Kopplin.seurat.obj.rds"))  
}


# ##### REMOVE CLUSTER 9
if (file.exists(file.path(path.to.01.output, "230215_Kopplin_seurat_obj.remove_clsuter9.rds")) == FALSE){
...
```{r results='asis', echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=10, dev='svg'}
##### add vdj information to the main seurat object
if (file.exists(file.path(path.to.01.output, "230215_Kopplin_seurat_obj.remove_clsuter9.addVDJ.rds")) == FALSE){
  ...
  saveRDS(s.obj, file.path(path.to.01.output, "230215_Kopplin_seurat_obj.remove_clsuter9.addVDJ.rds"))  
} 
```
